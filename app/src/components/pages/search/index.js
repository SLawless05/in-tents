    ...
    ></div>
      <div className="w3-content w3-container w3-padding-64" id="portfolio" >
        ...
        <div className="w3-row-padding w3-center">
          <div className="w3-col m3"><p>Yellowstone National Park</p>
            <img
          ...
          <div className="w3-col m3"><p>Grand Canyon</p>
            <img
          ...
          <div className="w3-col m3"><p>Grand Tetons National Park</p>
            <img
          ...
          <div className="w3-col m3"><p>Acadia National Park</p>
            <img
        ...
        <div className="w3-row-padding w3-center w3-section">
          <div className="w3-col m3"><p>Zion National Park</p>
            <img
          ...
          <div className="w3-col m3"><p>Glacier National Park</p>
            <img
          ...
          <div className="w3-col m3"><p>Olympic National Park</p>
            <img
          ...
          <div className="w3-col m3"><p>Rocky Mountains</p>
            <img
